...
# ===== 阪神北部歯科総研 ビジュアルシステム（SVG / 5色＋オレンジ・実写禁止）=====
...
def clean_title(t):
    """タイトルから冗長な『阪神北部』を除去（サイト名=阪神北部歯科総研で自明のため）"""
    t = re.sub(r"^【阪神北部エリア?】\s*", "", t)
    t = t.replace("｜阪神北部エリア版", "").replace("｜阪神北部版", "")
    t = t.replace("阪神北部で使える", "使える")
    t = t.replace("阪神北部で知る", "")
    t = t.replace("阪神北部のインプラント", "インプラント")
    t = t.replace("阪神北部ホワイトニング", "ホワイトニング")
    t = t.replace("阪神北部の", "").replace("阪神北部で", "").replace("阪神北部", "")
    t = re.sub(r"｜\s*(市版|版)", "", t)
...
def build():
    ...
    trend = pick(["阪神北部のインプラント費用", "歯周病治療の専門性", "阪神北部ホワイトニング",
                  "子どもの虫歯予防", "歯のクリーニング"])
...
FOOTER = '''<footer class="site-footer">
  <div class="wrap-x">
    ...
    <p class="foot-copy">© 阪神北部歯科総研 HANSHIN-NORTH DENTAL RESEARCH</p>
  </div>
</footer>
<script>
...
<title>歯科コラム | 阪神北部歯科総研</title>
<meta name="description" content="症状や治療の基礎知識、歯科医院の選び方まで。阪神北部で後悔しない歯科選びに役立つ情報をお届けします。">
<meta property="og:type" content="website">
<meta property="og:site_name" content="阪神北部歯科総研">
<meta property="og:title" content="歯科コラム | 阪神北部歯科総研">
<meta property="og:description" content="症状や治療の基礎知識、歯科医院の選び方まで。阪神北部で後悔しない歯科選びに役立つ情報をお届けします。">
<meta property="og:url" content="https://hanshinnorth.shikasoken.com/articles/index.html">
<link rel="canonical" href="https://hanshinnorth.shikasoken.com/articles/index.html">
...
<section class="hero">
  <div class="wrap-x">
    <div class="hero-in">
      ...
      <p class="lead">正しい知識は、納得できる歯科医院選びにつながります。<br>阪神北部歯科総研では、症状・治療・医院選びに役立つ情報を、<br>口コミや公開情報、AI分析の視点から整理しています。</p>
      <div class="search">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<title>{title} | 阪神北部歯科総研 コラム</title>
<meta name="description" content="{title}に関する阪神北部の歯科コラム記事一覧。">
<link rel="canonical" href="https://hanshinnorth.shikasoken.com/articles/{href}">
''' + STYLE + '''
<script src="../assets/site-config.js"></script>
<script src="../assets/odr-track.js"></script>
</head>
