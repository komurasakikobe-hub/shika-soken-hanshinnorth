...
def _ward_key(addr):
    m = _re.search(r"(伊丹市|宝塚市|川西市|三田市|猪名川町)", addr or "")
...
<title>{name}｜阪神北部歯科総研 AI Research Report</title>
<meta name="description" content="{desc}">
<meta property="og:type" content="article">
<meta property="og:site_name" content="阪神北部歯科総研">
<meta property="og:title" content="{name}｜阪神北部歯科総研 AI Research Report">
...
<body>
<header class="rr-nav">
  <a class="logo" href="../../index.html">阪神北部歯科総研<small>HANSHIN-NORTH DENTAL RESEARCH</small></a>
