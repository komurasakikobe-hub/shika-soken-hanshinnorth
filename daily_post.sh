#!/bin/zsh
# 阪神北部歯科総研 — 毎日投稿バッチ
# launchd（com.hanshinnorthshikasoken.dailypost.plist）から毎日呼び出される。
...
SITE_DIR="/Users/komurasakishoutaira/Desktop/クロード/阪神北部歯科総研"
...
# CLIENT_CONFIG環境変数で阪神北部用configを直接指定する（2026-07-10・大阪ペット医療ナビと同方式）
export CLIENT_CONFIG="$SURVEY_DIR/client_config_hanshinnorth.json"
